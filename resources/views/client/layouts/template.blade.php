...
<body>
            ...
            @if (!Auth::check())
                ...
                @else
                    <div class="header__top__right__auth">
                        ...
                        @else
                            <a href="{{ route('comment.list') }}"><i class="fa fa-dashboard"></i> Hệ thống</a>
                        @endif
                    </div>
                @endif
            @else
                            ...
                            @if (!Auth::check())
                                ...
                                @else
                                    <div class="header__top__right__auth">
                                        ...
                                        @else
                                            <a href="{{ route('comment.list') }}" class="text-white"><i class="fa fa-dashboard"></i> Hệ thống</a>
                                        @endif
                                    </div>
                                @endif
                            @else
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
	...
	<script>
		Stripe.setPublishableKey('pk_test_51NaiZNFPNyoDQ5DJaE8bXlnRH7WqFQkq6uZlhYs3ZdvYfgi3ScPlYD8bCVsKCfVPJJsRgqXRXB4kC3ANNGP9m5FC00wruLyFp4');
